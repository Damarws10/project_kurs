...
<div class="container">
                 ...
                 <!-- Panel. Use "panel-XXX" class for different colors. Replace "XXX" with color. -->
                  ...
                  <!-- Panel heading -->
                   ...
                   <div id="collapseOne-alt3" class="panel-collapse collapse">
                    ...
                    <div class="panel-body">
                      <a href="<?= base_url('bca') ?>"><h3>Kurs BCA</h3></a>
                    </div>
                   </div>
                  </div>
                  <div class="panel">
                  ...
                  <div class="panel">
                   ...
                   <div id="collapseThree-alt3" class="panel-collapse collapse">
                    <div class="panel-body">
                      <a href="<?= base_url('#') ?>"><h3>Kurs BRI</h3></a>
                    </div>
                   </div>
                  </div>
                </div>
  ...
  <div class="container">
      <h2 style="text-align: center;">TABEL KURS TRANSAKSI BRI</h2>
      <?php
    ...
    $code = get_web_page("https://kurs.dollar.web.id/bank.php/?/@BRI");
